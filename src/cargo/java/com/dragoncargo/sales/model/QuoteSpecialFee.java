...
@Entity
@Table(name = "quotespecialfee")
public class QuoteSpecialFee extends GenericDbInfo{
	...
	@ManyToOne
	@JoinColumn(name = "chargeUnitId", foreignKey = @ForeignKey(name = "fk_quoteSpecialFee_chargeUnitid"),
	...
	@ManyToOne
	@JoinColumn(name = "weightTypeId", foreignKey = @ForeignKey(name = "fk_quoteSpecialFee_weighttypeid"),
			referencedColumnName = "id")
