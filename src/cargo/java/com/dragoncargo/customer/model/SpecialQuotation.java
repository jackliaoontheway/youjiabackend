 ...
 * 特殊报价
 */
@ModelMetaData(showDetailFieldName = "specialQuotation")
@Entity
@Table(name = "specialquotation")
public class SpecialQuotation extends GenericDbInfo{
	...
	@ManyToOne
	@JoinColumn(name = "chargeUnitId", foreignKey = @ForeignKey(name = "fk_specialquotation_chargeUnitid"),
	...
	@ManyToOne
	@JoinColumn(name = "weightTypeId", foreignKey = @ForeignKey(name = "fk_specialquotation_weighttypeid"),
			referencedColumnName = "id")
